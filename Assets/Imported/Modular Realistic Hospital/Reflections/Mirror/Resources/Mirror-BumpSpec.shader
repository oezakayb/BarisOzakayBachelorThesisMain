...
inline float4 MirrorSpecular (SurfaceOutputStandardSpecular s, float2 screenPos, float NdotV, UnityGI gi)
{
    // energy conservation
    half oneMinusReflectivity;
    s.Albedo = EnergyConservationBetweenDiffuseAndSpecular (s.Albedo, s.Specular, /*out*/ oneMinusReflectivity);
...
inline fixed4 frag_surf (v2f_surf IN) : SV_Target {
  ...
  float3 worldViewDir = IN.worldViewDir;
  #endif
...
o.Normal = normalize(o.Normal);
  ...
  LightingStandardSpecular_GI(o, giInput, gi);
    o.Emission = MirrorSpecular (o, screenPos, dot(o.Normal, worldViewDir), gi)*2/3;
